...
public class CardsAdapter extends ArrayAdapter<DummyModel> {
	
	private LayoutInflater mInflater;
	
	public CardsAdapter(Context context, List<DummyModel> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageUtil.displayRoundImage(holder.image, item.getImageURL(), null);
